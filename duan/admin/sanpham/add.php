<div class="row2">
         ...
         <div class="row2 form_content ">
          ...
          <div class="row2 mb10">
           ...
           <div class="row2 mb10">
            <label>size </label> <br>
            <input type="text" name="size" placeholder="nhập vào size Sản Phẩm">
           </div>
           <div class="row2 mb10">
           ...
           <div class="row2 mb10">
            ...
            <input type="text" name="material" placeholder="nhập vào chat lieu san pham">
           </div>
           <div class="row2 mb10">
            <label>so luong </label> <br>
            <input type="text" name="quantity" placeholder="nhập vào so luong san pham">
           </div>
           <div class="row2 mb10">
